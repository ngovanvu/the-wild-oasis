  ...
  return (
    <ChartBox>
      ...
      <ResponsiveContainer width="100%" height={240}>
        <PieChart>
          {/* cx cy là vị trí của vòng tròn */}
          {/* innerRadius vòng ở tâm ra viền trong */}
          {/* outerRadius độ rộng ở từ viền trong ra tới viền ngoài */}
          {/* paddingAngle khoảng cách giữ các value */}
          <Pie
            data={data}
            nameKey="duration"
            dataKey="value"
